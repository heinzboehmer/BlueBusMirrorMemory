...
#define HANDLER_COMFORT_MIRRORS_UNSCHEDULED 0
#define HANDLER_COMFORT_MIRRORS_WAITING 1
#define HANDLER_COMFORT_MIRRORS_SCHEDULED 2
...
#define HANDLER_INT_COMFORT_MIRRORS 10000

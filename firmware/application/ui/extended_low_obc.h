...
#define EXTENDED_LOW_OBC_REFRESH_INT_MS (0.75 * EXTENDED_LOW_OBC_STOCK_TIMEOUT_MS)
...
// | Source | Length | Destination | Gear | RpmHi | RpmLo | Oil Temp | Coolant Temp | Vehicle Speed | Checksum |
